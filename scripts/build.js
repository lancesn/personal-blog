...
const assetVersion = "20260805-cover-picker-refresh-fix";
...
${robotsMeta}    <link rel="canonical" href="${escapeHtml(pageUrl)}" />
    ...
    <link rel="apple-touch-icon" href="/uploads/site-icon-touch.png?v=${assetVersion}" />
...
function siteFooter() {
  return `    <footer class="footer">
      <p>© 2026 Lance Shen. All rights reserved. 未经许可，禁止转载或用于商业用途。</p>
      <a class="share-icon-button footer-rss" href="${escapeHtml(absoluteUrl("rss.xml"))}" aria-label="订阅 RSS" title="订阅 RSS">${shareIcon("rss")}</a>
    </footer>`;
}
...
async function copyAndOptimizeUploads() {
  ...
  for (const entry of entries) {
    ...
    if (!rasterImageExtensions.has(extension) || entry.name === "site-icon-touch.png") {
